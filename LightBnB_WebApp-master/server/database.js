...
const getAllProperties = function(options, limit = 10) {
  ...
  // 5
  console.log('query string log', queryString, queryParams);
...
pool.query(`SELECT title FROM properties LIMIT 10;`).then(response => {console.log('success' /*response*/)})
...
const addProperty = function(property) {
  console.log('propertyLog', property)
